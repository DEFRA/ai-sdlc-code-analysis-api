#!/usr/bin/env python
"""
Script to test the generate_configuration_report node in isolation.

This script creates a sample CodeAnalysisState with test data and passes it to the
generate_configuration_report function to test it independently of the full LangGraph.
"""
...
from app.code_analysis.agents.nodes.configuration_report import (  # noqa: E402
    generate_configuration_report,  # noqa: E402
)
...
def create_test_state() -> CodeAnalysisState:
    ...
    try:
        ...
        logger.info(
            "Successfully loaded test state for configuration report generation"
        )
        return state
...
async def main() -> None:
    ...
    logger.info("Starting generate_configuration_report node test")
    ...
    try:
        ...
        save_output(
            ...
            script_dir,
            "configuration_report_result.json",
        )

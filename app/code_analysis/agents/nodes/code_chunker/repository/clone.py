...
def clone_repository(
    ...
    def _clone_operation():
        ...
        try:
            # Validate repository URL to mitigate security risks
            # Allow only characters that are valid in git URLs
            ...
            try:
                ...
                # Fetch from remote with depth 1
                ...
                if checkout_main.returncode == 0:
                    ...
                    if checkout_master.returncode == 0:
                        ...
                        if (
                            list_branches.returncode == 0
                            and list_branches.stdout.strip()
                        ):
